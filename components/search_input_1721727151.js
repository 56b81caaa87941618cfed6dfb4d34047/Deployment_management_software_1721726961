    ...
    { template: `
     <div class="bg-white p-4 rounded-lg shadow-md">
        <form class="space-y-4">
            ...
            <button type="submit" class="w-full px-4 py-2 text-white bg-purple-500 rounded-md hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50">Submit</button>
        </form>
     </div>
  `, 
    delimiters: ['{','}'],
